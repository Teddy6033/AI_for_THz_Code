...
if __name__ == "__main__":
    ...
    d = DataUnit(args,
                 r"D:\DL\AI_for_THz_Code\data_space\datasets_txt\unloaded_dataset_for_technology\train\d1=1; d2=6; gx=6; gy=28; hhsub=200; phi=0; px=120; theta=0; thick=0.2; w=8.txt")
