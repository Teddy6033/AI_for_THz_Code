...
forward_tar = r"../data_space/checkpoints/feature-F-prediction-network-checkpoint.pth.tar"
...
pbz2_path = r'..\data_space\dataset_pbz2\shap_values_F.pbz2'
...
# 保存为高分辨率图像
# plt.savefig(r'..\data_space\shap_figures\shap dot on F.png', dpi=1200)  # 300 DPI for high resolution
plt.show()
...
#     # 选择一个实例
#     instance_index = i
#     # 绘制 Force Plot，使用 Matplotlib
#     shap.force_plot(explainer.expected_value, shap_values[instance_index], X_test[instance_index], matplotlib=True, feature_names=features,figsize=(10, 6),)
#     # 绘制 Decision Plot
#     shap.decision_plot(explainer.expected_value, shap_values[instance_index], X_test[instance_index], feature_names=features,link="identity",highlight=True)
